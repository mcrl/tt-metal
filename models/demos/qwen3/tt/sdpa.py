...
def sdpa_forward_prefill(
    ...
    with Profiler().trace_with_timer("to_layout", level=3, args={"class": "sdpa_forward_prefill"}):
        attn_output = ttnn.to_layout(ttnn.permute(attn_output, dims=(0, 2, 1, 3), memory_config=ttnn.L1_MEMORY_CONFIG), layout=ttnn.ROW_MAJOR_LAYOUT, memory_config=ttnn.L1_MEMORY_CONFIG)
