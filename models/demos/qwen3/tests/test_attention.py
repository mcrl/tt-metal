...
from models.demos.qwen3.utils.test_utils import assert_hidden_dim_pcc, get_model_config, run_module_forward
...
def test_attention_prefill_forward(mode, seq_len, hf_config, tmp_path, mesh_device):
    ...
    assert_hidden_dim_pcc(tt_out_torch, ref_out, pcc_required=0.98)
