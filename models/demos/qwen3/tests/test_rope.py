...
def test_rope(batch_size, seq_len, heads, head_dim, mesh_device):
    ...
    ttnn_position_embeddings = ttnn_precompute_freqs_cis(Qwen3MoeConfig(head_dim=head_dim, max_seq_len=seq_len))
    ...
    tt_out = ttnn_apply_rotary_emb(q_tt, k_tt, (cos_tt, sin_tt))
