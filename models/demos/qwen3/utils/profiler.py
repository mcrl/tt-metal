...
from models.demos.qwen3.utils.timer import (
    start_timer,
    stop_timer,
    timer_enabled,
    set_and_get_device_cache,
    sync_and_time,
    sync,
)
    ...
    if profiler_enabled():
        ...
        try:
            ...
            with open(output_file, "a+") as f:
                ...
                trace_data = {"traceEvents": all_events, "displayTimeUnit": "ms"}
...
class Profiler:
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        if name is not None and level is not None and level_enabled(level):
            ...
            end_event = self._create_event(name, CATEGORIES.get(level, "Unknown"), "E", self._pid, tid, end_time, args)
