...
// moe_expert_projection Operation
//
// PURPOSE:
...
struct MoeExpertProjectionOperation {
...
constexpr auto moe_expert_projection = ttnn::register_operation<
    "ttnn::moe_expert_projection",
    ttnn::operations::experimental::MoeExpertProjectionOperation>();
