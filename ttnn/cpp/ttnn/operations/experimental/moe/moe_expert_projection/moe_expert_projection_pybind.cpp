...
#include "moe_expert_projection_pybind.hpp"
#include "moe_expert_projection.hpp"
...
void bind_moe_expert_projection(py::module& module) {
    const auto doc = R"doc(
moe_expert_projection(hidden_states: ttnn.Tensor, routed_tokens: ttnn.Tensor, num_routed_tokens: ttnn.Tensor, expert_weights: ttnn.Tensor, device_expert_mapping: ttnn.Tensor, top_k: int, *, memory_config: ttnn.MemoryConfig = None, queue_id: int = 0) -> ttnn.Tensor
...
Example:
    ...
    >>> gate_output = ttnn.moe_expert_projection(
    ...
    using OperationType = decltype(ttnn::moe_expert_projection);
    ttnn::bind_registered_operation(
        module,
        ttnn::moe_expert_projection,
        doc,
