...
#include "device/moe_down_projection_op.hpp"
#include "ttnn/operations/experimental/moe/moe_down_projection/moe_down_projection.hpp"

namespace ttnn::operations::experimental {

ttnn::Tensor MoeDownProjectionOperation::invoke(
    QueueId queue_id,
    ...
    auto operation = moe::MoeDownProjection{
