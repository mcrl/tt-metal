...
struct MoeDownProjectionOperation {
...
constexpr auto moe_down_projection = ttnn::register_operation<
    "ttnn::moe_down_projection",
    ttnn::operations::experimental::MoeDownProjectionOperation>();
