...
// extract_attention_input_decode Operation
//
// PURPOSE:
...
//
// INPUTS:
//   - hidden_state: [1, 1, B, H] bfloat16 tensor, TILE_LAYOUT - input token embeddings (replicated)
//   - mesh_device: MeshDevice - device mesh to extract DP from
//
// OUTPUTS:
//   - output: [1, 1, B//dp, H] tensor - extracted batch chunk for this device
//
// COMPUTATION:
...
//   - Output is sharded along DP dimension (dimension 2)
//   - Supports output dtype conversion (bfloat16 or bfloat8_b)

namespace ttnn {
namespace operations::experimental {

struct ExtractAttentionInputDecodeOperation {
...
constexpr auto extract_attention_input_decode = ttnn::register_operation<
    "ttnn::extract_attention_input_decode",
    ttnn::operations::experimental::ExtractAttentionInputDecodeOperation>();
