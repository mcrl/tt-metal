...
// Dummy reader kernel for extract_attention_input_decode
...
void kernel_main() {
    ...
    constexpr uint32_t hidden_dim = get_compile_time_arg_val(1);
    constexpr uint32_t dp = get_compile_time_arg_val(2);
