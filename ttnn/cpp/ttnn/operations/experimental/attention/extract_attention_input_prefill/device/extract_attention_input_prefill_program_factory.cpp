...
operation::ProgramWithCallbacks extract_attention_input_prefill_single_core(
    ...
    auto reader_kernel = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/experimental/attention/extract_attention_input_prefill/device/kernels/dataflow/reader_extract_attention_input_prefill.cpp",
        all_cores,
        ReaderDataMovementConfig(reader_compile_args));

    auto writer_kernel = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/experimental/attention/extract_attention_input_prefill/device/kernels/dataflow/writer_extract_attention_input_prefill.cpp",
        all_cores,
